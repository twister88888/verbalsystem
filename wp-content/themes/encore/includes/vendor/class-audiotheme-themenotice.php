...
class AudioTheme_ThemeNotice {
	...
	public function __construct( $args = array() ) {
		if ( ! $this->is_audiotheme_active() && is_admin() && current_user_can( 'activate_plugins' ) ) {
			$this->strings = array(
				'notice'     => __( 'The AudioTheme plugin should be installed and activated for this theme to display properly.', 'encore' ),
				'activate'   => __( 'Activate now', 'encore' ),
				'learn_more' => __( 'Find out more', 'encore' ),
				'dismiss'    => __( 'Dismiss', 'encore' ),
			);
